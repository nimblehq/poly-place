...
android {
    ...
    defaultConfig {
        applicationId = "co.co.nimblehq.showcases.poly.place"
...
dependencies {
    ...
    implementation("androidx.constraintlayout:constraintlayout-compose:${Versions.COMPOSE_CONSTRAINT_VERSION}")
